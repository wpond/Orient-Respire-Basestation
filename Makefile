...
-mfix-cortex-m3-ldrd -fomit-frame-pointer -Wall  $(DEPFLAGS)
...
program: $(EXE_DIR)/$(PROJECTNAME).out
	@echo "Programming"
	$(GDB) --se $(EXE_DIR)/$(PROJECTNAME).out
